...
filetype off
syntax off
hi StatusLineTerm ctermbg=none ctermfg=none cterm=bold,reverse
hi StatusLineTermNC ctermbg=none ctermfg=none cterm=reverse
...
augroup vimrc
au!
au BufNewFile guide call setline(1, './ ^agit ^alsp apropos fw gw')
